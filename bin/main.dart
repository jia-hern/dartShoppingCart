...
const allProducts = [
  ...
  Product(id: 2, name: 'bananas', price: 0.60),
  Product(id: 3, name: 'craneberries', price: 1.50),
  Product(id: 4, name: 'strawberries', price: 2.10),
  Product(id: 5, name: 'pineapples', price: 2.80),
  Product(id: 6, name: 'kiwis', price: 1.20),
];
